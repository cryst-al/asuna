...
function library:Introduction()
    ...
    local barCorner = Instance.new("UICorner")
    local barLayout = Instance.new("UIListLayout")
    local AsunaLogo = Instance.new("ImageLabel")
    local hashLogo = Instance.new("ImageLabel")
    local Asuna = Instance.new("TextLabel")
    ...
    AsunaLogo.Name = "AsunaLogo"
    AsunaLogo.Parent = background
    AsunaLogo.AnchorPoint = Vector2.new(0.5, 0.5)
    AsunaLogo.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    AsunaLogo.BackgroundTransparency = 1.000
    AsunaLogo.Position = UDim2.new(0.5, 0, 0.5, 0)
    AsunaLogo.Size = UDim2.new(0, 448, 0, 150)
    AsunaLogo.Visible = true
    AsunaLogo.Image = "http://www.roblox.com/asset/?id=9365068051"
    AsunaLogo.ImageColor3 = Color3.fromRGB(159, 115, 255)
    AsunaLogo.ImageTransparency = 1
    ...
    Asuna.Name = "Asuna"
    Asuna.Parent = background
    Asuna.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    Asuna.BackgroundTransparency = 1.000
    Asuna.Size = UDim2.new(0, 80, 0, 21)
    Asuna.Font = Enum.Font.Code
    Asuna.Text = "powered by Asuna"
    Asuna.TextColor3 = Color3.fromRGB(124, 124, 124)
    Asuna.TextSize = 10.000
    Asuna.TextTransparency = 1
    ...
    CreateTween("AsunaRotation", 0)
    local MinusAmount = -16
    coroutine.wrap(function()
        while wait() do
            MinusAmount = MinusAmount + 0.4
            TweenService:Create(AsunaLogo, TweenTable["AsunaRotation"], {Rotation = AsunaLogo.Rotation - MinusAmount}):Play()
        end
    end)()
    ...
    wait(.2)
    TweenService:Create(Asuna, TweenTable["introduction"], {TextTransparency = 0}):Play()
    TweenService:Create(text, TweenTable["introduction"], {TextTransparency = 0}):Play()
    wait(.3)
    TweenService:Create(AsunaLogo, TweenTable["introduction"], {ImageTransparency = 0}):Play()
    wait(2)
    TweenService:Create(AsunaLogo, TweenTable["introduction"], {ImageTransparency = 1}):Play()
    wait(.2)
    ...
    wait(.1)
    TweenService:Create(Asuna, TweenTable["introduction"], {TextTransparency = 1}):Play()
    wait(.1)
...
function library:Init(key)
    ...
    function TabLibrary:NewTab(title)
        ...
        tabButton.TextColor3 = Color3.fromRGB(129, 56, 59)
        ...
        tabButton.MouseButton1Click:Connect(function()
            ...
            for i,v in pairs(tabButtons:GetChildren()) do
                if v:IsA("TextButton") then
                    TweenService:Create(v, TweenTable["tab_text_colour"], {TextColor3 = Color3.fromRGB(129, 56, 59)}):Play()
                end
            end
